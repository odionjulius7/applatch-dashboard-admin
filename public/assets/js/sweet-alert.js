$(function () {
    ...
    showSwal = function (type) {
        ...
        if (type === 'delete-post') {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure you want <br> to block this user?',
                text: "",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonClass: 'mr-2',
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure you want to <br> verify this user as a sensei?',
                text: "",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonClass: 'mr-2',
