$(function() {
    ...
    // Monthly student chart start
    if ($('#monthly-student-chart').length) {
        var monthlySalesChart = document.getElementById('monthly-student-chart').getContext('2d');
        new Chart(monthlySalesChart, {
            type: 'bar',
            data: {
                labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
    ...
    // Monthly Student chart end

    // Monthly Sensei chart start
    if ($('#monthly-sensei-chart').length) {
        var monthlySalesChart = document.getElementById('monthly-sensei-chart').getContext('2d');
        new Chart(monthlySalesChart, {
            type: 'bar',
            data: {
                labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
                datasets: [{
                    label: 'Students',
                    data: [160, 190, 140, 100, 150, 110, 125, 110, 90, 115, 120, 120],
                    backgroundColor: colors.primary
                }]
            },
            options: {
